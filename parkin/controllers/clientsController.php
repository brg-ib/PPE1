...
switch ($action) {
    ...
    case 'connexion': $mailUser=$_REQUEST['mailUser']; $passwordUser=$_REQUEST['passwordUser']; if (connecter($bdd, $mailUser, $passwordUser)) {
        header('Location:index.php');
    } else {
        header('Location:index.php?module=clients&action=form_connexion&erreur=true');
    } break;
